...
public class StarterKlasse {
	...
	public static void main(String[] args) throws IOException {
		...
		String spielfeld; //String f�r die Spielfeldgr��e und die Schiffsmengen
		String ipAdress = "";
		
		
		final int port = 50000;
		
		//Hier �ber Gui, Moduswahl Ob Offline, Online etc .. 
		...
		//Dem Client die Spielfeldgr��e mitteilen bzw. diese vom Server bekommen
		if(role.equals("Server")) {
			 
			spielfeld = "10"; //Hier kommt unsere Benutzereingabe von der GUI wie gro� das spielfeld sein soll, im Beispiel hier 10
			spielfeld = "setup "+spielfeld+" "+helfer.kalkuliereSchiffe(Integer.parseInt(spielfeld)); //Die Spielfeldgroe�e an das Objekt der Helferklasse �bergeben und die Schiffe ermitteln
			
			out.write(spielfeld+" \n");	
			out.flush();
			System.out.println("Dem Client die Spielgr��e mitgeteilt");
		}else {
			
			spielfeld = in.readLine();	//Belegung des Spielfeldes vom Gegner lesen
			System.out.println("Vom Server die Spielgr��e mitgeteilt bekommen");
